  ...
  async function onSubmit(data: FormData) {
    ...
    try {
      ...
      if (roleData?.role !== 'owner') {
        await supabase.auth.signOut();
        throw new Error('Unauthorized: You do not have an Owner account.');
      }
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          <h2 className="text-xl font-semibold text-slate-900 mb-6">Sign in to Owner Portal</h2>
          ...
          <p className="text-center text-sm text-slate-500 mt-6">
            ...
            <Link href="/owner/signup" className="text-primary-600 font-medium hover:underline">
              Sign up
            </Link>
          </p>
        </div>
